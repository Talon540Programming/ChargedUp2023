...
public class ArmVisualizer {
   ...
   *
   * @param logKey key to log the state of the arm under. Note, this cannot be repeated or incorrect
   *     or unintended data may be logged.
  ...
  public ArmVisualizer(String logKey, ArmKinematics armKinematics) {
    ...
    MechanismRoot2d fulcrum = m_mechanism.getRoot("Arm Fulcrum", 2, fulcrumHeightMeters);
   ...
   *
   * <p>For 2d Objects, the angle of the entire arm is updated and individual ligaments / extrusions
   * / stages are updated to their estimated length based on kinematics.
   *
   * <p>For 3d Objects, the estimated position of the end of each extrusion / stage is updated.
   *
   * @param armAngleRad angle of the arm.
   * @param armLengthMeters total distance of the arm from the fulcrum to the end of the effector in
   *     meters.
   */
