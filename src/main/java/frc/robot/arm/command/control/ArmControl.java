...
public abstract class ArmControl extends CommandBase {
    ...
    private static final LoggedDashboardChooser<Double> m_rotationSpeedLimiter = new LoggedDashboardChooser<>("Rotation Speed Limit");
    private static final LoggedDashboardChooser<Double> m_extensionSpeedLimiter = new LoggedDashboardChooser<>("Extension Speed Limit");
