...
public class ArmRotationIOSparkMax implements ArmRotationIO {
   ...
   */
  public ArmRotationIOSparkMax(int rotationLeader, int rotationFollower, boolean rotationInverted, int encoderID, double absoluteEncoderOffset) {
    // CONFIGURE ENCODER
    ...
    this.m_rotationLeader = new CANSparkMax(rotationLeader, CANSparkMaxLowLevel.MotorType.kBrushless);
    this.m_rotationFollower = new CANSparkMax(rotationFollower, CANSparkMaxLowLevel.MotorType.kBrushless);
  ...
  public void updateInputs(ArmRotationIOInputs inputs) {
    inputs.CurrentAmps = new double[] {m_rotationLeader.getOutputCurrent(), m_rotationFollower.getOutputCurrent()};
    inputs.TemperatureCelsius =
        new double[] {m_rotationLeader.getMotorTemperature(), m_rotationFollower.getMotorTemperature()};
