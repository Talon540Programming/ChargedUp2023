...
public class AutoBuilder {
  ...
  private final LoggedDashboardChooser<GridToRobotPose> m_startingPose =
      new LoggedDashboardChooser<>("AutoBuilder/StartingPose");
  private final LoggedDashboardChooser<GridDepositionLevels> m_initialDepositionLevel =
      new LoggedDashboardChooser<>("AutoBuilder/StartingLevel");

  private final LoggedDashboardChooser<FloorPiecePose> m_firstPiece =
      new LoggedDashboardChooser<>("AutoBuilder/FirstCargo");
  private final LoggedDashboardChooser<GridToRobotPose> m_firstPieceDepositionPose =
      new LoggedDashboardChooser<>("AutoBuilder/FirstCargoDepositionPose");
  private final LoggedDashboardChooser<GridDepositionLevels> m_firstDepositionLevel =
      new LoggedDashboardChooser<>("AutoBuilder/FirstLevel");

  private final LoggedDashboardChooser<FloorPiecePose> m_secondPiece =
      new LoggedDashboardChooser<>("AutoBuilder/SecondCargo");
  private final LoggedDashboardChooser<GridToRobotPose> m_secondPieceDepositionPose =
      new LoggedDashboardChooser<>("AutoBuilder/SecondCargoDepositionPose");
  private final LoggedDashboardChooser<GridDepositionLevels> m_secondDepositionLevel =
      new LoggedDashboardChooser<>("AutoBuilder/SecondLevel");

  private final LoggedDashboardChooser<FloorPiecePose> m_thirdPiece =
      new LoggedDashboardChooser<>("AutoBuilder/ThirdCargo");
  private final LoggedDashboardChooser<GridToRobotPose> m_thirdPieceDepositionPose =
      new LoggedDashboardChooser<>("AutoBuilder/ThirdCargoDepositionPose");
  private final LoggedDashboardChooser<GridDepositionLevels> m_thirdDepositionLevel =
      new LoggedDashboardChooser<>("AutoBuilder/ThirdLevel");

  private final LoggedDashboardChooser<FloorPiecePose> m_fourthPiecePose =
      new LoggedDashboardChooser<>("AutoBuilder/FourthCargo");
  private final LoggedDashboardChooser<GridToRobotPose> m_fourthPieceDepositionPose =
      new LoggedDashboardChooser<>("AutoBuilder/FourthCargoDepositionPose");
  private final LoggedDashboardChooser<GridDepositionLevels> m_fourthDepositionLevel =
      new LoggedDashboardChooser<>("AutoBuilder/FourthLevel");

  private final LoggedDashboardChooser<Boolean> m_levelAtEnd =
      new LoggedDashboardChooser<>("AutoBuilder/LevelAtEnd");
  ...
  public Command getCommand() {
    ...
    if (m_startingPose.get() != null) {
      autoCommand =
          autoCommand.andThen(
              Commands.runOnce(
                  () -> m_driveBase.resetPosition(m_startingPose.get().pose), m_driveBase));
    }
    ...
    if (m_firstPiece.get() != null
        && m_firstPieceDepositionPose != null
        && m_firstDepositionLevel != null) {
      ...
      PathPlannerTrajectory firstPath =
          PathPlanner.generatePath(
              RobotLimits.kTrajectoryConstraints,
              List.of(getPointFromPose(startingPose), getPointFromPose(gamePiecePose)));
      PathPlannerTrajectory secondPath =
          PathPlanner.generatePath(
              RobotLimits.kTrajectoryConstraints,
              true,
              List.of(
                  getPointFromPose(GeomUtil.invertAngle(gamePiecePose)),
                  getPointFromPose(GeomUtil.invertAngle(gamePieceDepositionPose))));
    ...
    if (m_secondPiece.get() != null
        && m_secondPieceDepositionPose != null
        && m_secondDepositionLevel != null) {
    ...
    if (m_thirdPiece.get() != null
        && m_thirdPieceDepositionPose != null
        && m_thirdDepositionLevel != null) {
    ...
    if (m_fourthPiecePose.get() != null
        && m_fourthPieceDepositionPose != null
        && m_fourthDepositionLevel != null) {
