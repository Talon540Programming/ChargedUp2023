  ...
  public WPIFollowTrajectory(DriveBase driveBase, Trajectory trajectory) {
    super(
        ...
        new RamseteController(
            ControlValues.Trajectory.kRamseteB, ControlValues.Trajectory.kRamseteZeta),
        new SimpleMotorFeedforward(
            ControlValues.WheelSpeed.kS, ControlValues.WheelSpeed.kV, ControlValues.WheelSpeed.kA),
        Constants.Drivetrain.kDrivetrainKinematics,
        driveBase::getWheelSpeeds,
        new PIDController(
            ControlValues.WheelSpeed.kP, ControlValues.WheelSpeed.kI, ControlValues.WheelSpeed.kD),
        new PIDController(
            ControlValues.WheelSpeed.kP, ControlValues.WheelSpeed.kI, ControlValues.WheelSpeed.kD),
