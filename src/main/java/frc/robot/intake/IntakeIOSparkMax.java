...
public class IntakeIOSparkMax implements IntakeIO {
    ...
    public IntakeIOSparkMax(int leftId, int rightId, I2C.Port colorSensorPort, double positionConversionFactor, double velocityConversionFactor) {
    ...
    public void updateInputs(IntakeInputs inputs) {
        ...
        inputs.CurrentAmps = new double[] { m_leftMotor.getOutputCurrent(), m_rightMotor.getOutputCurrent()};
        inputs.TemperatureCelsius = new double[] { m_leftMotor.getMotorTemperature(), m_rightMotor.getMotorTemperature()};
